...
//   node render.mjs still 6.0    write output/still-12.80.png
...
const outMp4 = resolve(root, 'output/linear-mac-sessions.mp4');
...
else if (cmd === 'still') await still(parseFloat(arg ?? '6.0'));
